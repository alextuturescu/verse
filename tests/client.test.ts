...
const testAddresses = [
  {
    ...
    address: '9euTPp193ESjEefX7xD4Li9CQvqzReemccBFq6AAEmABDSFWaTR',
  },
  {
    sk: 'ff00',
...
mock.onGet('/transactions/boxes/byAddress/unspent/9euTPp193ESjEefX7xD4Li9CQvqzReemccBFq6AAEmABDSFWaTR').reply(200,
  [{
